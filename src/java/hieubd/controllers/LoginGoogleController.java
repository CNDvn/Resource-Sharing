...
import hieubd.utils.GoogleUtil;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (code != null & !code.isEmpty()) {
                ...
                dto = GoogleUtil.getUserInfo(accessToken);
                dto = new UsersDAO().checkLoginGoogle(dto.getEmail());
                if (dto != null) {
                    ...
                    String errorString = "You have not our member, please regist to become our member";
